        ...
        <div className="sections">
          <div className="info">
            ...
            <select name="cats" id="cats">
              ...
              <option value="web"> Video & Animation</option>
              ...
              <option value="web"> Music & Audio</option>
              <option value="animation">Programming & Tech</option>
              <option value="music"> Data Analysis</option>
            </select>
